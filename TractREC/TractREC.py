...
def crop_data(img_data,buffer=3,buffer_fill=0,crop_coords=None):
    """
    :param img_data:        3d numpy array
    :param buffer:          number of voxels outside the crop to include
    :param buffer_fill:     value to fill buffer with
    :param crop_coords:     coordinates to crop from, of the form [[x1,x2],[y1,y2],[z1,z2]], or None
    :return: img_data_crop, crop_coords
    """
...
def extract_stats_from_masked_image(img_fname, mask_fname, thresh_mask_fname=None, combined_mask_output_fname=None,
                                    ROI_mask_fname=None, thresh_val=1, \
                                    thresh_type='upper', result='all', label_subset=None, SKIP_ZERO_LABEL=True,
                                    nonzero_stats=True, \
...
def extract_quantitative_metric(metric_files, label_files, IDs=None, label_df=None, label_subset_idx=None,
                                ...
                                thresh_mask_files=None, ROI_mask_files=None, thresh_val=0.35, max_val=1,
                                thresh_type='upper', erode_vox=None, zfill_num=3, \
